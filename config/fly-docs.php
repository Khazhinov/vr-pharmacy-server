...
return [
    ...
    'documentations' => [
        'latest' => [
            'info' => [
                'title' => 'VR Pharmacy',
                'description' => 'Документация для API проекта VR Pharmacy',
                'version' => '1.0',
                'license' => [
...
//             ],
        ...
        */
        'security_definitions' => [
            'security_schemes' => [
                GoldSpecDigital\ObjectOrientedOAS\Objects\SecurityRequirement::create()->securityScheme('ApiAuthSecurityScheme'),
            ],
        ],
