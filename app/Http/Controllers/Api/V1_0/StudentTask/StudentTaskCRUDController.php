...
namespace App\Http\Controllers\Api\V1_0\StudentTask;

use App\Http\Requests\StudentTask\StudentTaskStoreRequest;
use App\Http\Requests\StudentTask\StudentTaskUpdateRequest;
use App\Http\Resources\StudentTask\StudentTaskCollection;
use App\Http\Resources\StudentTask\StudentTaskResource;
...
#[OpenApi\PathItem]
final class StudentTaskCRUDController extends ApiCRUDController
{
    ...
    public function __construct()
    {
        parent::__construct(new ApiCRUDControllerMetaDTO([
            'model_class' => StudentTask::class,
            'single_resource_class' => StudentTaskResource::class,
            'collection_resource_class' => StudentTaskCollection::class,
        ]));
    }
     ...
     */
    #[OpenApi\Operation(tags: ['StudentTask'])]
    #[OpenApi\Complex(
        factory: IndexActionComplex::class,
        model_class: StudentTask::class,
        collection_resource: StudentTaskCollection::class,
        options: []
    )]
    ...
    #[OpenApi\Complex(
        ...
        model_class: StudentTask::class,
        single_resource: StudentTaskResource::class,
        options: []
    )]
     ...
     * Создание сущности
     *
     * @param  StudentTaskStoreRequest  $request
     * @return Response
     * @throws JsonException
     * @throws ReflectionException
     * @throws Throwable
    ...
    #[OpenApi\Complex(
        ...
        model_class: StudentTask::class,
        single_resource: StudentTaskResource::class,
        validation_request: StudentTaskStoreRequest::class,
        options: []
    )]
    public function store(StudentTaskStoreRequest $request): Response
    {
     ...
     *
     * @param  StudentTaskUpdateRequest  $request
     * @param  string $key Идентификатор сущности
     * @return Response
     * @throws JsonException
     * @throws ReflectionException
    ...
    #[OpenApi\Complex(
        ...
        model_class: StudentTask::class,
        single_resource: StudentTaskResource::class,
        validation_request: StudentTaskUpdateRequest::class,
        options: []
    )]
    public function update(StudentTaskUpdateRequest $request, string $key): Response
    {
