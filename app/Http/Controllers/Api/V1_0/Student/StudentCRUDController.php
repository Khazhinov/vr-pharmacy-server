...
namespace App\Http\Controllers\Api\V1_0\Student;
...
#[OpenApi\PathItem]
final class StudentCRUDController extends ApiCRUDController
{
    ...
    public function __construct()
    {
        parent::__construct(new ApiCRUDControllerMetaDTO([
            ...
            'single_resource_class' => StudentResource::class,
            'collection_resource_class' => StudentCollection::class,
        ]));
    }
     ...
     */
    #[OpenApi\Operation(tags: ['Student'])]
    #[OpenApi\Complex(
        factory: IndexActionComplex::class,
        model_class: Student::class,
        collection_resource: StudentCollection::class,
        options: []
    )]
    ...
    #[OpenApi\Complex(
        ...
        model_class: Student::class,
        single_resource: StudentResource::class,
        options: []
    )]
    ...
    #[OpenApi\Complex(
        ...
        model_class: Student::class,
        single_resource: StudentResource::class,
        validation_request: StudentStoreRequest::class,
        options: []
    )]
    ...
    #[OpenApi\Complex(
        ...
        model_class: Student::class,
        single_resource: StudentResource::class,
        validation_request: StudentUpdateRequest::class,
        options: []
    )]
    public function update(StudentUpdateRequest $request, string $key): Response
    {
